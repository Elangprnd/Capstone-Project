...
router.post('/', authenticate, authorize('lembaga'), upload.array('image'), misiController.createMissionHandler)
router.put('/:id', authenticate, authorize('lembaga'), upload.array('image'), misiController.updateMissionHandler)
router.patch('/:id', authenticate, authorize('lembaga'), upload.array('image'), misiController.updateMissionHandler)
